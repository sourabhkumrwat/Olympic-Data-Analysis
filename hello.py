...
if user_menu == 'Overall Analysis':
    ...
    st.title("Athltes over the year")
    st.plotly_chart(fig)
...
if user_menu == 'Medal Predictions':
    st.title("Medal Predictions for 2020 and 2024 Olympics")

    # Call the prediction function
    prediction_dfs = helper.predict_medals(df, years_to_predict=[2020, 2024])

    # Plot bar graph for 2020 predictions
    st.subheader("Top 10 Predicted Countries for 2020")
    fig_2020 = px.bar(
        prediction_dfs[2020],
        x='Country',
        y='Predicted Medals',
        title="2020 Olympics Medal Predictions",
        color='Predicted Medals'
    )
    st.plotly_chart(fig_2020)

    # Plot bar graph for 2024 predictions
    st.subheader("Top 10 Predicted Countries for 2024")
    fig_2024 = px.bar(
        prediction_dfs[2024],
        x='Country',
        y='Predicted Medals',
        title="2024 Olympics Medal Predictions",
        color='Predicted Medals'
    )
